...
# ==============================================================================
# 이 파일은 시스템 전반의 설정을 관리한다.
# 환경 변수나 .env 파일로부터 설정을 로드하여, GPT API 키, 모델 경로, 데이터베이스 경로 등
# 시스템의 핵심 동작에 필요한 설정 값들을 중앙에서 관리하고 제공한다.
# 다른 모듈들은 이 파일의 `settings` 객체를 통해 필요한 설정에 접근한다.
# ==============================================================================
