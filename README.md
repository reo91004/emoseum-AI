...
| 역할           | 개발자 | GitHub                                       | 담당 업무                                                                                                                            |
| -------------- | ------ | -------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| **AI 개발**    | 박용성 | [@reo91004](https://github.com/reo91004)     | • GPT 프롬프트 엔지니어링 (이미지 생성, 도슨트)<br>• Stable Diffusion 이미지 생성<br>• GPT API 서비스<br>• LoRA/DRaFT+ 개인화 시스템 |
...
- **OpenAI GPT-4**: 프롬프트 생성 및 도슨트 메시지
